...
- Checks: `ref-path`, `ref-command`, `ref-target`, `size-bytes`, `shape-headings`, `shape-lines`. The rest of the plan's ids are registered as planned so configs can name them.
